...
export interface GetChatRespnse {
  ok: boolean;
  error: string | null;
  chat: Chat | null;
}
...
export type StatusOptions = "ACCEPTED" | "FINISHED" | "CANCELED" | "REQUESTING" | "ONRIDE";
